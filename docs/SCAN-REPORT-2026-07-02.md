...
| wowhead.com/…/15309 Hesback (Gladiator S2, Firemaw-EU) | WebFetch (полный текст) | 15 матчапов Warr/Pala POV с рейтингами: **«Mage Rogue 7/10»** (усиливает rm-vs-warrior-hpala: уже в sources), **«Rogue DPriest 4/10»** (rp-vs-warrior-hpala: уже в sources), hpala-техники vs rogue-команды (Stoneform, Sac-аптайм, BoP/трикет-экономия) → обвязка новых драфтов |
