...
- **priest+warrior** (2v2): Mixster-план (Jun 12, 2008): рог на воина; при свапе воина на прийста — SS к их присту + PI mana burn; тринкет kidney → blind → SS priest.
