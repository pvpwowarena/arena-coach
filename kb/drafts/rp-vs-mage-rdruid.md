...
- Играть в бурст-гонку вместо OOM-плана по магу — источник описывает матч именно как кайт/мана-войну (поэтому 5/10), а не burst-kill.
- Вкладывать сетап в друида при свободном [[ability:cyclone]] — его прийст снять не может (источник).
- Не диспелить mage-контроль с напарника — весь комфорт RP здесь в том, что прийст чистит [[ability:sheep]]/root («dispel everything except cyclone»).
- Дать друиду спокойно пить/innervate и затянуть матч — long game играет на их хилера (WT: «longer games vs other healers/DPS»).

## Key cooldowns to track

- enemy: druid — [[ability:cyclone]] (не диспелится), Nature's Swiftness, innervate, barkskin, trinket; mage — [[ability:ice-block]], blink, [[ability:counterspell]], [[ability:sheep]], [[ability:nova]], Spellsteal, trinket.
- ours: [[ability:mana-burn]], [[ability:pain-suppression]], dispel, [[ability:fear]], [[ability:sap]], [[ability:garrote]], [[ability:gouge]], [[ability:kidney-shot]], [[ability:blind]], [[ability:vanish]], [[ability:cloak-of-shadows]], [[ability:will-of-the-forsaken]], trinket.
