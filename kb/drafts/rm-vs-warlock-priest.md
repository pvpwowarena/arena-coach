...
Если прийст — dwarf, нужно [[ability:blind]] его сразу когда он тринкетит, до того как он успеет stoneform + desperate prayer обратно в full HP; потом [[ability:sap]] между dot tick'ами и держим cloak до второго setup'а.
...
Если прийст тринкетит — быстро blind'ишь и возвращаешься к варлоку.
