...
_Провенанс: матчап-якорь — in-depth DP/R-гайд Deadlycoward (Infernal Gladiator, top-10 EU DP/R season 1) на Warcraft Tavern, секция «DPR vs. друид / Frost маг» (5/10). Прямо из источника: фокус и план — сап мага, дисп прийста, оом мага манабёрном, кайт; добив друида в human form после его тринкета. DPR-strengths WT подтверждают, что дисп-прийст комфортен против frost-маг и друид roots («dispel everything except циклон»). Пошаговое исполнение (роговый combo, др, тайминги тринкетов) синтезировано на sourced-каркасе из механик TBC 2.4.3. Теги `sourced`/`author-guide`/`synthesized-execution` — перед approve желательно ревью топ-RP._

Матчап (источник, Deadlycoward, 5/10): frost-маг + resto-друид — каст-дамаг под кайт-хилером. Для RP это **не бурст-гонка, а игра на ману**. фокус — вражеский **маг**, которого выжимают в оом манабёрном (fallback — друид, добиваемый в human form после его тринкета). Источник прямо: «kill маг by making him run out of mana / kill друид after his тринка».
